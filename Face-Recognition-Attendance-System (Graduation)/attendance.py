...
class Attendance:
    def __init__(self,root):
        ...
        #first image
        img=Image.open(r"C:\Users\Alahram\Desktop\Face-Recognition-Attendance-System (Graduation)\images\attendance2.jpg")
        ...
        #second image
        img1=Image.open(r"C:\Users\Alahram\Desktop\Face-Recognition-Attendance-System (Graduation)\images\1.jpg")
        ...
        #back ground image
        img3=Image.open(r"C:\Users\Alahram\Desktop\Face-Recognition-Attendance-System (Graduation)\images\attendance1.png")
        img3=img3.resize((1530,515),Image.Resampling.LANCZOS)
        self.photoimg3=ImageTk.PhotoImage(img3)

        bg_img=Label(self.root,image=self.photoimg3)
        bg_img.place(x=0,y=200,width=1530,height=515)

        title_lbl=Label(bg_img,text="ATTENDANCE MANAGEMENT SYSTEM",font=("times new roman",35,"bold"),bg="white",fg="#00008B")
        ...
        img_left=Image.open(r"C:\Users\Alahram\Desktop\Face-Recognition-Attendance-System (Graduation)\images\attendance1.png")
        img_left=img_left.resize((720,110),Image.Resampling.LANCZOS)
